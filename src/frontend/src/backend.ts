...
import type { AnalysisResult as _AnalysisResult, ConditionResult as _ConditionResult, DetectedRegions as _DetectedRegions, EdgeFeatures as _EdgeFeatures, ExternalBlob as _ExternalBlob, ImageId as _ImageId, RegionScore as _RegionScore, ScreeningId as _ScreeningId, ScreeningRecord as _ScreeningRecord, SegmentationResult as _SegmentationResult, TextureFeatures as _TextureFeatures, Timestamp as _Timestamp, UserRole as _UserRole, WhitePatchRegion as _WhitePatchRegion, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async analyzeEyeImage(arg0: ExternalBlob, arg1: WhitePatchInput): Promise<AnalysisResult> {
        if (this.processError) {
            try {
    ...
    async deleteScreening(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async generateSummary(arg0: Array<ConditionResult>): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getScreening(arg0: string): Promise<ScreeningRecord | null> {
        if (this.processError) {
            try {
    ...
    async getScreeningHistory(): Promise<Array<ScreeningRecord>> {
        if (this.processError) {
            try {
    ...
    async saveScreening(arg0: AnalysisResult, arg1: string): Promise<string> {
        if (this.processError) {
            try {
...
function from_candid_AnalysisResult_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalysisResult): AnalysisResult {
    return from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_RegionScore_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RegionScore): RegionScore {
    return from_candid_record_n13(_uploadFile, _downloadFile, value);
}
function from_candid_ScreeningRecord_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ScreeningRecord): ScreeningRecord {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TextureFeatures]): TextureFeatures | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_EdgeFeatures]): EdgeFeatures | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DetectedRegions]): DetectedRegions | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SegmentationResult]): SegmentationResult | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ScreeningRecord]): ScreeningRecord | null {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    detectionQuality: string;
    regionScores: Array<_RegionScore>;
    whitePatchUsed: _WhitePatchRegion;
    detectedRegions: [] | [_DetectedRegions];
    segmentationResult: [] | [_SegmentationResult];
    timestamp: _Timestamp;
    conditions: Array<_ConditionResult>;
    imageId: _ImageId;
}): {
    detectionQuality: string;
    regionScores: Array<RegionScore>;
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    avgR: number;
    brightness: number;
    textureFeatures: [] | [_TextureFeatures];
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RegionScore>): Array<RegionScore> {
    return value.map((x)=>from_candid_RegionScore_n12(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ScreeningRecord>): Array<ScreeningRecord> {
    return value.map((x)=>from_candid_ScreeningRecord_n23(_uploadFile, _downloadFile, x));
}
function to_candid_AnalysisResult_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AnalysisResult): _AnalysisResult {
...
function to_candid_RegionScore_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RegionScore): _RegionScore {
...
function to_candid_vec_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<RegionScore>): Array<_RegionScore> {
